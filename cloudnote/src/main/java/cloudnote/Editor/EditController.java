...
public class EditController {
    ...
    @RequestMapping(value = "get/page/update.json", method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "media.json", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "tags/update.json", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "thumbnails.json", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "slide_templates.json", method = RequestMethod.GET)
