...
public class FriendVO {
	...
	public FriendVO(String a_request_m_id, String b_response_m_id, String a_consent, String b_consent) {
		super();
	...
	public String toString() {
		return "FriendVO [a_request_m_id=" + a_request_m_id + ", b_response_m_id=" + b_response_m_id + ", a_consent="
				+ a_consent + ", b_consent=" + b_consent + "]";
	}
